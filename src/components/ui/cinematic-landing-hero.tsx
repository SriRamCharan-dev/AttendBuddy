...
const INJECTED_STYLES = `
  ...
  /* Deep Physical Card — Emerald/Dark for AttendBuddy */
  .premium-depth-card {
      background: linear-gradient(145deg, #0A2E1C 0%, #0A101D 100%);
      box-shadow: 
...
export function CinematicHero({ 
  ...
  ctaDescription = "30 seconds to set up. Works on any phone with Telegram. Your entire class joins with one link.",
  telegramBotLink = "https://t.me/YourBotUsername",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  return (
    ...
    >
      ...
      {/* BACKGROUND LAYER 2: Tactile CTA — Telegram button */}
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href={telegramBotLink} target="_blank" rel="noopener noreferrer" aria-label="Open in Telegram" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
            {/* Telegram Logo SVG */}
            <svg className="w-8 h-8 transition-transform group-hover:scale-105" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M11.99 0C5.372 0 0 5.373 0 12s5.372 12 11.99 12C18.627 24 24 18.627 24 12S18.627 0 11.99 0zm5.872 8.173l-1.975 9.314c-.15.666-.54.825-1.093.513l-3.018-2.225-1.456 1.401c-.161.161-.296.296-.607.296l.217-3.075 5.597-5.058c.243-.217-.053-.337-.377-.12l-6.918 4.356-2.98-.93c-.648-.203-.662-.648.135-.96l11.646-4.488c.54-.196 1.012.13.83.961z"/>
            </svg>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Open in</div>
              <div className="text-xl font-bold leading-none tracking-tight">Telegram</div>
            </div>
          </a>
          <a href="#how-it-works" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-background">
            <svg className="w-6 h-6 transition-transform group-hover:translate-y-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
            </svg>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">See</div>
              <div className="text-xl font-bold leading-none tracking-tight">How It Works</div>
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            {/* 2. MIDDLE (Mobile) / CENTER (Desktop): IPHONE MOCKUP — AttendBuddy UI */}
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Attendance</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-emerald-500/20 text-emerald-300 flex items-center justify-center font-bold text-sm border border-emerald-500/30 shadow-lg shadow-black/50">
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="text-[11px] font-semibold text-white/90 mb-0.5">Marked Present</div>
                            <div className="text-[9px] text-neutral-500">Today, 9:00 AM</div>
                          </div>
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="text-[11px] font-semibold text-white/90 mb-0.5">3 days skippable</div>
                            <div className="text-[9px] text-neutral-500">This month&apos;s budget</div>
                          </div>
                        </div>
                      </div>
                ...
                {/* Floating Glass Badges — AttendBuddy themed */}
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">15-day Streak</p>
                    <p className="text-emerald-200/50 text-[10px] lg:text-xs font-medium">Never missed a check-in</p>
                  </div>
                </div>
